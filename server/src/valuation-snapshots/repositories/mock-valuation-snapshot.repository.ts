...
import { IValuationSnapshotRepository } from './valuation-snapshot.repository.interface';
...
@Injectable()
export class MockValuationSnapshotRepository implements IValuationSnapshotRepository {
